...
namespace API.Controllers
{
    ...
    public class ProductsController : BaseApiController
    {
        ...
        {
            var spec = new ProductWithTypesAndBrandSpecification(id);//For overcoming drawback of generic method
        ...
        public async Task<ActionResult<IReadOnlyList<ProductBrand>>> GetProductBrands()
        {
            ...
            return Ok(await _productBrandRepo.ListAllAsync());  //done with using Generic Classes
        }
